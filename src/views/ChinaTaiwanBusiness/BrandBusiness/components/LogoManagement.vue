<template>
  <el-dialog title="Logo信息" :visible.sync="dialogVisible" width="50%" :close-on-click-modal="false">
    ...
    <el-table :data="tableData" border style="width: 100%" stripe size="small">
      ...
      <el-table-column prop="edition" label="Logo版本" width="180" align="center">
      </el-table-column>
      <el-table-column prop="author" label="Logo作者" width="180" align="center">
      </el-table-column>
      <el-table-column prop="explain" label="构思说明" align="center">
      </el-table-column>
      <el-table-column prop="time" label="最后更新时间" align="center">
      </el-table-column>
      ...
      <el-table-column label="操作" width="150" align="center">
        <template slot-scope="scope">
          ...
          <!-- <button class='bttn-stretch bttn-md bttn-danger' @click="del(scope.$index)" v-if="!scope.row.explain">
            <svg-icon icon-class="delete" /></button> -->
        </template>
      </el-table-column>
    </el-table>

    <el-drawer title="Logo上传" :append-to-body="true" :visible.sync="drawer" :direction="direction"
      ...
      <el-row style="width:100%;height:100%">
        ...
        <el-row>
          <el-form label-width="100px" label-position="right" :model="RemarksFrom">
            <el-form-item label="构思说明">
