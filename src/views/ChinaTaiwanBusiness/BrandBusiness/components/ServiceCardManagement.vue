<template>
  <el-dialog title="售后服务卡信息" :visible.sync="dialogVisible" width="70%" :close-on-click-modal="false">
    ...
    <el-table :data="tableData" border style="width: 100%" stripe size="small">
        ...
        <template slot-scope="props">
          <el-row>
            <el-col :span="4" class="borderShow">
              ...
              <a target="_blank" href="http://www.w3school.com.cn">售后服务卡文案.excel</a>
            </el-col>
      ...
      <el-table-column prop="edition" label="服务卡版本" width="100" align="center">
      </el-table-column>
    ...
    <el-drawer title="售后服务卡文案上传" :append-to-body="true" :visible.sync="copydrawer" :direction="direction"
    ...
    <el-drawer title="售后服务卡图片上传" :append-to-body="true" :visible.sync="picdrawer" :direction="direction"
