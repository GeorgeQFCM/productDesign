<template>
  <section>
    ...
    <el-card>
      <el-form size="small" inline :model="QueryFrom" style="margin-top:10px;margin-left:5px">
        <el-form-item label="物料编码">
          <el-input v-model="QueryFrom.materialcode" placeholder="多个物料编码请用英文逗号( , )隔开" style="width:500px" clearable>
          </el-input>
        </el-form-item>
        <el-form-item>
          <el-button size="small" type="primary" @click="searchList">&nbsp;&nbsp;查&nbsp;&nbsp;询&nbsp;&nbsp;
          </el-button>
        </el-form-item>
      </el-form>
    ...
    <el-card style="margin-top: 10px">
      ...
      <el-table border :data="dataList" v-loading="tableLoading" ref="multipleTable" stripe
        ...
        <el-table-column label="物料编码" width="110" prop="materialcode" align="center" show-overflow-tooltip>
        ...
        <el-table-column label="组合属性" prop="productname" align="center" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column label="申请备货数量" width="100" prop="stockquantity3" align="center" clearable fixed="right">
          <template slot-scope="scope">
            <el-input v-model="scope.row.stockquantity3" placeholder="请输入"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="期望交期" prop="deliverydate" header-align="center" width="130px" fixed="right">
          <template slot-scope="scope">
            <el-date-picker v-model="scope.row.deliverydate" type="date" placeholder="选择日期" size="small">
            </el-date-picker>
          </template>
        </el-table-column>
        <el-table-column label="申请备货建议运输方式" width="120" prop="stockquantity" align="center" clearable fixed="right">
          <template slot-scope="scope">
            <el-select v-model="scope.row.stockquantity" placeholder="请选择">
              <el-option label="空运" value="空运"></el-option>
              <el-option label="海运" value="海运"></el-option>
            </el-select>
          </template>
        </el-table-column>
        <el-table-column label="申请备货说明" prop="stockquantity4" align="center" clearable fixed="right">
          <template slot-scope="scope">
            <el-input v-model="scope.row.stockquantity4" placeholder="请输入"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="备货类型" width="120" prop="stockquantity5" align="center" clearable fixed="right">
          <template slot-scope="scope">
            <el-select v-model="scope.row.stockquantity5" placeholder="请选择">
              <el-option label="紧急备货" value="紧急备货"></el-option>
              <el-option label="项目备货" value="项目备货"></el-option>
            </el-select>
          </template>
        </el-table-column>
    ...
    data() {
      return {
        RecordForm: {
          ...
          endTime: "2021-06-28",
          describe: "紧急备货和项目备货合并;7.29增加期望交期需求",
        },
        QueryFrom: {
          materialcode: "",
        },
