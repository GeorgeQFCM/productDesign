<template>
  <section>
    ...
    <el-row style="margin-top: 10px" :gutter="5">
      <el-col :span="10">
        <el-card>
          <ApplyAnalysisi ref="ApplyAnalysisi"></ApplyAnalysisi>
        </el-card>
        <el-card>
          <el-row>
            <el-col :span="12">
              <EmergencyReasons ref="EmergencyReasons"></EmergencyReasons>
            </el-col>
            <el-col :span="12">

              <ProjectReasons ref="ProjectReasons"></ProjectReasons>
      ...
      <el-col :span="14">
        <el-card>
          <el-table border :data="dataList" v-loading="tableLoading" size="mini" height="630px">
              ...
              <template slot="header">
                <div>
                  ...
                  <el-popover placement="bottom" title="筛选" width="400" trigger="click">
                    <el-input size="mini" v-model="materialcodeQuery" placeholder="支持多条件过滤，例如北京 上海"></el-input>
            ...
            <el-table-column label="事业部-Team" prop="BusinessTeam" align="center" show-overflow-tooltip>
              <template slot="header">
                <div>
                  <span>事业部-Team</span>
                  <el-popover placement="bottom" title="筛选" width="400" trigger="click">
                    <el-input size="mini" v-model="BusinessTeamQuery" placeholder="支持多条件过滤，例如北京 上海"></el-input>
                    <div style="border: 1px solid #758a99;margin:5px 0px; height: 300px; overflow: auto;">
                      <div style="margin:5px 15px;">
            ...
            <el-table-column label="平台-区域" prop="PlatformArea" align="center" show-overflow-tooltip>
              <template slot="header">
                <div>
                  <span>平台-区域</span>
                  <el-popover placement="bottom" title="筛选" width="400" trigger="click">
                    <el-input size="mini" v-model="PlatformAreaQuery" placeholder="支持多条件过滤，例如北京 上海"></el-input>
                    <div style="border: 1px solid #758a99;margin:5px 0px; height: 300px; overflow: auto;">
                      <div style="margin:5px 15px;">
...
<script>
  import ApplyAnalysisi from './echartCompont/ApplyAnalysisi.vue'
  import EmergencyReasons from './echartCompont/EmergencyReasons.vue'
  import ProjectReasons from './echartCompont/ProjectReasons.vue'
