<template>
  <section>
    ...
    <el-row style="margin-top: 10px" :gutter="5">
      <el-col :span="10">
        <el-card>
          <DaliyApplyAnalysisi ref="DaliyApplyAnalysisi"></DaliyApplyAnalysisi>
        </el-card>
        <el-card>
          <ReasonAnalysisi ref="ReasonAnalysisi"></ReasonAnalysisi>
...
<script>
  import DaliyApplyAnalysisi from './echartCompont/DaliyApplyAnalysisi.vue'
  import ReasonAnalysisi from './echartCompont/ReasonAnalysisi.vue'
