  ...
  <div>
    ...
    <el-card style="margin-top: 10px">
      ...
      <el-table border :data="dataList" v-loading="tableLoading" @select="checkChange" @select-all="selectAll"
        ...
        <el-table-column label="建议备货数量" prop="recommendStockNum" align="center" show-overflow-tooltip>
        </el-table-column>
        <el-table-column label="预采购量" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="原因" align="center">
          <template slot-scope="scope">
            <el-select v-model="scope.row.reason">
              <el-option value="a原因" label="a原因"></el-option>
              <el-option value="b原因" label="b原因"></el-option>
            </el-select>
          </template>
        </el-table-column>
        <el-table-column label="其它" width="100" align="center">
          <template slot-scope="scope">
